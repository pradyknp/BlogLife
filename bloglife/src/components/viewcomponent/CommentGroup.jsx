        ...
        return (
            <div>
                ...
                <div className="allComments" ref="allComments">
                    ...
                    <div className="likeDislike"><button className="upvoteBut"><img src={upvote} alt="like" className="upvote"></img></button>&nbsp;
                        3{this.props.commentData.likes} &nbsp; &nbsp; &nbsp; <button className="upvoteBut"><img src={downvote} alt="dislike" className="upvote"></img></button>&nbsp;3{this.props.commentData.dislikes}</div>
                </div>
            </div>
        );
    }
